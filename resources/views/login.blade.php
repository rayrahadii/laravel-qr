...
<html lang="en">
    ...
    <body id="kt_body" class="bg-body">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center">
                                ...
                                {{-- <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                                    <img alt="Logo"
                                        href="{{ asset('assets/media/svg/brand-logos/google-icon.svg') }}"
                                        class="h-20px me-3" />Continue with Google</a> --}}
                                <!--end::Google link-->
                                <!--begin::Google link-->
                                {{-- <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                                    <img alt="Logo"
                                        href="{{ asset('assets/media/svg/brand-logos/facebook-4.svg') }}"
                                        class="h-20px me-3" />Continue with Facebook</a> --}}
                                <!--end::Google link-->
                                <!--begin::Google link-->
                                {{-- <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100">
                                    <img alt="Logo"
                                        href="{{ asset('assets/media/svg/brand-logos/apple-black.svg') }}"
        ...
        <script href="{{ asset('assets/plugins/global/plugins.bundle.js') }}"></script>
        <script href="{{ asset('assets/js/scripts.bundle.js') }}"></script>
        <!--end::Global Javascript Bundle-->
        <!--begin::Page Custom Javascript(used by this page)-->
        <script href="{{ asset('assets/js/custom/authentication/sign-in/general.js') }}"></script>
